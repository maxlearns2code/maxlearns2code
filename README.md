...
*Developed the frontend for an AI Agent application as part of Sweden’s largest AI hackathon (Google Cloud AI Hackathon, Stockholm, June 2025).  
**Tech:** Next.js, Tailwind CSS, Framer Motion, Shadcn UI, Zustand, TypeScript 
**Focus:** UI/UX, state management, theming, and groundwork for future AI integration.*
