...
After ten years in finance and HR in Paris, I transitioned into web development to build products instead of just managing processes. My focus is modern, accessible, and maintainable web applications with React, Next.js, and TypeScript, using Vercel for deployment, routing, and edge caching, and Node.js, Express, and Firebase/Firestore for real-world data needs.​

This mix of business and engineering helps me translate requirements into shipped features that feel intuitive to both stakeholders and end-users.
...
- **Backend:** Node.js, Express.js, Firebase (Auth & Firestore), MongoDB
- **API & Data:** REST APIs, Axios, JSON data handling
- **Testing & Quality:** Jest, performance & optimization, DX-focused tooling
- **DevOps & Hosting:** Vercel, Render/Cloud Run, Docker, Git & GitHub, Sanity (CMS), Cloudflare
- **AI:** Retrieval-Augmented Generation (RAG) chatbot, AI-powered UI integrations
...
- **Tech:** Next.js, TypeScript, Tailwind CSS, next-intl (i18n).  
- **Infrastructure:** Deployed on Vercel for fast global delivery and simple maintenance.

---

## 💡 Hackathons & Community

- **Google Cloud AI Hackathon (2025):** Built and demoed an AI agent frontend in Stockholm’s largest AI event.
- **Techarena 2025:** Volunteer at Scandinavia’s largest tech and business event, supporting logistics and networking.
- **Open Source:** Contributor to community-driven projects, always open to collaboration.

---

## 💬 What Drives Me

- Transforming business needs into intuitive digital experiences.
- Rapid prototyping and delivering under tight deadlines (hackathons, freelance, and team projects).
- Continuous learning—currently exploring advanced React patterns, Next.js internationalization, and AI integration in web apps.
...
- Volleyball player (Rågsveds IF)
- Web design and creative coding
- Exploring AI and Web3

---

*Open to roles where modern web development, AI, and product thinking meet. let’s build something impactful together!*
